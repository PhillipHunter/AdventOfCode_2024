...
using static AOC2024.Puzzles.Day9Part2;
...
namespace AOC2024.Tests.Puzzles
{
    public class Day9Part2Tests
    {
        ...
        {
            CommonTests.ValidateNameField<Day9Part2>();
        }
        ...
        //{
        //    CommonTests.ValidateOutput<Day9Part2>(false);
        //}
        ...
        [Fact]
        public void GetFirstEmptyBlockIndexOfProperLength_WhenCalled_ReturnsProperValue()
        {
            // Arrange
            // csharpier-ignore
            var fileBlocks = new List<int?> { 0, null, 0, null, null, 0 };
            var expected = 3;
            var targetLength = 2;

            // Act
            var result = GetFirstEmptyBlockIndexOfProperLength(fileBlocks, targetLength);
        ...
        public void GetDefragmentedList_WhenCalled_ReturnsProperValue()
        {
            ...
            var expected =   new List<int?> { 0, 0, 9, 9, 2, 1, 1, 1, 7, 7, 7, null, 4, 4, null, 3, 3, 3, null, null, null, null, 5, 5, 5, 5, null, 6, 6, 6, 6, null, null, null, null, null, 8, 8, 8, 8, null, null };
