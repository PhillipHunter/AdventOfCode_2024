...
namespace AOC2024.Tests.Puzzles
{
    public class Day2Part1Tests
    {
        ...
        {
            // Arrange
            var sut = new Day2Part1 { ExampleRun = true };
        ...
        public void GetReportArray_WhenCalled_ReturnsProperValue()
        {
            ...
            // Act
            var result = Day2Part1.GetReportArray(input);
        ...
        public void AreAllIncreasing_WhenCalled_ReturnsProperValue()
        {
            ...
            // Act
            var result = input.Select(Day2Part1.AreAllIncreasing).ToList();
        ...
        public void AreAllDecreasing_WhenCalled_ReturnsProperValue()
        {
            ...
            // Act
            var result = input.Select(Day2Part1.AreAllDecreasing).ToList();
        ...
        public void GetMaxDeltaAmount_WhenCalled_ReturnsProperValue()
        {
            ...
            // Act
            var result = input.Select(Day2Part1.GetMaxDeltaAmount).ToList();
