...
using static AOC2024.Puzzles.Day10Part2;
...
namespace AOC2024.Tests.Puzzles
{
    public class Day10Part2Tests
    {
        ...
        {
            CommonTests.ValidateNameField<Day10Part2>();
        }

        [Fact]
        public void GetOutput_WhenCalledWithExample_ReturnsExampleAnswer()
        {
            CommonTests.ValidateOutput<Day10Part2>(true);
        }

        [Fact]
        public void GetOutput_WhenCalledWithoutExample_ReturnsAnswer()
        {
            CommonTests.ValidateOutput<Day10Part2>(false);
        }
        ...
        {
            // Arrange
            var sut = new Day10Part2_Agent(new Point(5, 4), new Point(5, 4));
        ...
        public void GetAllPointsOfValue_WhenCalled_ReturnsProperAnswer()
        {
            ...
            // Act
            var result = Day10Part2.GetAllPointsOfValue(_exampleMap, value);
