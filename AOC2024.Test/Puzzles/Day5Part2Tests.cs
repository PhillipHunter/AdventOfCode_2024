...
namespace AOC2024.Tests.Puzzles
{
    public class Day5Part2Tests
    {
        ...
        public void GetPertinentRules_WhenCalled_ReturnsProperValue()
        {
            ...
            // Act
            var result = Day5Part2.GetPertinentRules(ruleSet, pageUpdates);
        ...
        public void GetPageInProperPlace_WhenCalledInOrder_ReturnsTrue()
        {
            ...
            {
                // Act
                var result = Day5Part2.GetPageInProperPlace(
                    pageUpdate,
                    pageUpdates,
                    pertinentRules
                );
        ...
        public void GetPageInProperPlace_WhenCalledOutOfOrder_ReturnsFalse()
        {
            ...
            // Act
            var result = Day5Part2.GetPageInProperPlace(47, pageUpdates, pertinentRules);
