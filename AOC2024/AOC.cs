...
namespace AOC2024
{
    public class AOC
    {
        ...
        public static IAdventPuzzle[] GetAdventPuzzles()
        {
            ...
            AdventPuzzles.Add(new Day7Part2());
            AdventPuzzles.Add(new Day8Part1());
            AdventPuzzles.Add(new Day8Part2());
            AdventPuzzles.Add(new Day9Part1());
            AdventPuzzles.Add(new Day10Part1());
            AdventPuzzles.Add(new Day10Part2());
            AdventPuzzles.Add(new Day11Part1());
