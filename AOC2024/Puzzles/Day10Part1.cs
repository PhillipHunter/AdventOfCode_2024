...
{
    public class Day10Part1 : IAdventPuzzle
    {
        public string Name => "Day 10: Hoof It Part 1";
        public string? Solution => "822";
        public string? ExampleSolution => "36";
        ...
        public PuzzleOutput GetOutput()
        {
            ...
            var agents = new List<Day10Part1_Agent>();

            var startingPoints = GetAllPointsOfValue(worldMap, 9);

            foreach (var startingPoint in startingPoints)
            {
                agents.Add(new Day10Part1_Agent(startingPoint, startingPoint));
            }
            ...
            {
                foreach (var agent in new List<Day10Part1_Agent>(agents))
                {
                    ...
                    else
                    {
                        ...
                        {
                            agents.Add(new Day10Part1_Agent(nextPosition, agent.OriginPosition));
                        }
                    }
        ...
        public class Day10Part1_Agent(Point point, Point originPoint)
        {
