...
namespace AOC2024.Puzzles
{
    ...
    {
        public string Name => "Day 8: Resonant Collinearity Part 1";
        public string? Solution => "293";
        public string? ExampleSolution => "14";
        ...
        public static List<Point> FindAntipodes(List<char[]> map, char character)
        {
            ...
            foreach (var currPoint in pointsForChar)
            {
                ...
                foreach (var otherPoint in otherPointsForChar)
                {
                    ...
                    var antipodePoint = otherPoint + new Size(slope.run, slope.rise);
